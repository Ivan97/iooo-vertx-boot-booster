package tech.iooo.coco.cofiguration;
...
public class VerticleConfiguration {
  ...
  @Bean("demoDeploymentOptions")
  public DeploymentOptions demoDeploymentOptions() {
    return new DeploymentOptions().setInstances(2);
  }
}
